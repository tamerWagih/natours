...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFtZXJ3YWdpaCIsImEiOiJja2ZjbjF1cGMxOWt5MnVvNTBwaDVjbmt1In0.IQ8u3kqg3-0cWemqxYuDoA';
...
var updatSetting = /*#__PURE__*/function () {
  ...
  return function updatSetting(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updatSetting = updatSetting;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSetting.updatSetting)({
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6806" + '/');
